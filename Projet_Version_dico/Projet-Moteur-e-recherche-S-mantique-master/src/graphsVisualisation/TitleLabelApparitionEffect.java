...
/**
 * The class TitleLabelApparitionEffect is a extension of the class Thread that permits to make a 
 * fade-in apparition for the element "title_label" in the GraphVisualisationJFrame class.
 */
public class TitleLabelApparitionEffect extends Thread {
	...
	/**
	 * TitleLabelApparitionEffect() is the main constructor of this class. It creates a loop that
	 * changes transparency of the title label element in the interface.
	...
	public TitleLabelApparitionEffect(VisualisationJFrame f) {
		...
		if(this.main_frame != null) {
			...
			if(title_label != null) {
				...
				//Useful for repositionning the label at the end of the animation
	...
	public void run() {
		if(this.main_frame != null && this.title_label != null) {
			...
			System.out.println("Erreur de lancement de l'animation pour l'élément title_label");
		}
	}
}
